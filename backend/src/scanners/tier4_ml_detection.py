...
TIER_NAME = "Tier 4: Machine Learning-Based Detection"
TIER_CODE = "TIER4_ML_DETECTION"
CHECK_COUNT = 100
FAMILIES = ['anomaly-detection', 'behavior-analysis', 'entropy-analysis', 'malware-signature', 'botnet-correlation']
