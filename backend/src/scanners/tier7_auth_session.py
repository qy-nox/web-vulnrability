...
TIER_NAME = "Tier 7: Authentication & Session"
TIER_CODE = "TIER7_AUTH_SESSION"
CHECK_COUNT = 100
FAMILIES = ['mfa-bypass', 'session-fixation', 'token-replay', 'password-reset', 'ldap-injection', 'kerberos-exploitation']
