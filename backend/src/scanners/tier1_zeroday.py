...
TIER_NAME = "Tier 1: Critical Zero-Day Detection"
TIER_CODE = "TIER1_ZERODAY"
CHECK_COUNT = 120
FAMILIES = ['advanced-sqli', 'dom-xss', 'template-injection', 'deserialization', 'type-juggling', 'toctou', 'memory-corruption']
