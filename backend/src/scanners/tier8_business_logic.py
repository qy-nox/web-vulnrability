...
TIER_NAME = "Tier 8: Business Logic"
TIER_CODE = "TIER8_BUSINESS_LOGIC"
CHECK_COUNT = 100
FAMILIES = ['price-manipulation', 'workflow-bypass', 'authz-bypass', 'transaction-reversal', 'account-lockout-bypass']
