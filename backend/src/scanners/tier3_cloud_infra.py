...
TIER_NAME = "Tier 3: Cloud & Infrastructure Security"
TIER_CODE = "TIER3_CLOUD_INFRA"
CHECK_COUNT = 105
FAMILIES = ['aws-misconfig', 'azure-misconfig', 'gcp-misconfig', 'kubernetes', 'terraform', 'bucket-exposure', 'secret-detection']
